...
void populateArithToXlsPatterns(RewritePatternSet& patterns,
                                MLIRContext* context) {
  // Call the generated pattern population function from the mlir::xls namespace
  // The patterns are generated by the .td file and included above in mlir::xls scope
  mlir::xls::populateWithGenerated(patterns);
}
