...
Scalar SerialReduction(const LinalgGeneric& g, const BroadcastAnalysis& A, 
  ...
  switch (cfg.reduce_policy()) {
    case LinalgCodegenConfig::ReducePolicy::kSerial:
      rctx.policy = ReducePolicy::kSerial;
      break;
    case LinalgCodegenConfig::ReducePolicy::kKahan:
      rctx.policy = ReducePolicy::kKahan;
      break;
    case LinalgCodegenConfig::ReducePolicy::kTree:
  ...
  Scalar result;
  if (cfg.reduce_policy() == LinalgCodegenConfig::ReducePolicy::kKahan) {
