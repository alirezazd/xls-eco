...
#ifndef XLS_CONTRIB_MLIR_TRANSFORMS_LINALG_HELPERS_H_
#define XLS_CONTRIB_MLIR_TRANSFORMS_LINALG_HELPERS_H_
...
#endif  // XLS_CONTRIB_MLIR_TRANSFORMS_LINALG_HELPERS_H_
